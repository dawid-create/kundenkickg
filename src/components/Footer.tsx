        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4 relative z-10">
            ...
            <nav className="flex flex-col space-y-2">
              ...
              <a href="/#method-timeline" className="text-gray-300 hover:text-[#8d3cca] hover:font-medium transition-all duration-200">
                Methode
              </a>
              <a href="/referenzen" className="text-gray-300 hover:text-[#8d3cca] hover:font-medium transition-all duration-200">
                Referenzen
              </a>
              <a href="/ueber-uns" className="text-gray-300 hover:text-[#8d3cca] hover:font-medium transition-all duration-200">
                Über Uns
              </a>
              <a href="/roi-rechner" className="text-gray-300 hover:text-[#8d3cca] hover:font-medium transition-all duration-200">
                ROI Rechner
              </a>
