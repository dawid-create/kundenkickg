...
const BraunschweigMethodSteps: React.FC = () => {
  const [activeStep, setActiveStep] = useState(0);

  useEffect(() => {
    const handleScroll = () => {
      const section = document.getElementById('braunschweig-method-timeline');
      if (!section) return;
  ...
  const steps = [
    {
      ...
      description: "Wir prüfen deine Online-Präsenz, Keywords und Konkurrenz in Braunschweig.",
      image: "/images/StockImageMagnifyingGlass.png",
      alt: "SEO Analyse Braunschweig - Konkurrenz und Keywords prüfen"
    },
    {
      icon: <Target className="w-8 h-8 text-[#8d3cca]" />,
      title: "Traffic & Sichtbarkeit",
      description: "Wir kombinieren lokale SEO mit Google Ads – damit du auf Seite 1 erscheinst, wenn deine Kunden dich suchen.",
      image: "/images/Stock Image Goolge.png",
      alt: "Google Ads Agentur Braunschweig - Lokale Sichtbarkeit verbessern"
    },
    {
      icon: <TrendingUp className="w-8 h-8 text-[#8d3cca]" />,
      title: "Optimierung & Skalierung",
      description: "Durch kontinuierliche Tests und Anpassungen steigern wir deine Leads und senken deine Kosten pro Anfrage.",
      image: "https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop",
      alt: "Marketing Optimierung Braunschweig - Leads steigern und Kosten senken"
    }
  ];

  return (
    <section id="braunschweig-method-timeline" className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-gray-900 via-[#8d3cca] to-gray-900 bg-clip-text text-transparent mb-6">
            Die KundenKick Methode: Mehr Traffic, Mehr Leads, Mehr Wachstum
          </h2>
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Aus über 50 erfolgreichen Kampagnen haben wir eine bewährte Methode entwickelt, 
            die lokalen Unternehmen in Braunschweig dabei hilft, online sichtbar zu werden und konstant neue Kunden zu gewinnen.
          </p>
        </div>
        ...
        <div className="text-center mt-16 p-8 bg-gradient-to-r from-[#8d3cca]/10 to-[#7a35b3]/10 rounded-2xl border border-[#8d3cca]/20">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">
            📈 Ergebnis: Mehr Besucher, mehr Anfragen, mehr Umsatz.
          </h3>
          <p className="text-lg text-gray-600">
            So funktioniert nachhaltiges Wachstum für dein Unternehmen in Braunschweig.
          </p>
        </div>
      </div>
    </section>
...
export default BraunschweigMethodSteps;